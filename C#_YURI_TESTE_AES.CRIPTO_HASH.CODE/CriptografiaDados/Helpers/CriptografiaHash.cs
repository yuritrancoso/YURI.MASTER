//ISSO AI GALERINHA, QUALQUER DUVIDA MANDA UM EMAIL yurirtgn@gmail.com
...
namespace CriptografiaDados.Helpers
{
    public class CriptografiaHash
    {
        public static string GerarSHA1_2(string value)
        {
        ...
        public static string GetMD5Hash(string input)
        {
            ...
            return MD5Core.GetHashString(bs);
        }
    }
    ...
    {
        //Previne o CSC de adicionar um contrutor "publico" padrão 
        private MD5Core() { }
        ...
        public static byte[] GetHash(byte[] input)
        {
            ...
            //Valores iniciais definidos em RFC 1321
        ...
        internal static byte[] GetHashFinalBlock(byte[] input, int ibStart, int cbSize, ABCDStruct ABCD, Int64 len)
        {
            ...
            //Padding é somente 1 bit singular,seguido do numero de "0s" necessario para fazer o "tamanho congruente de 448 modulo 512". 
            //Primeiro passo para RFC 1321  
            // O CLR garante nosso "buffer" de "0 - atribuido", logo não precisamos explicitamente seta-lo.
            //Esse é o motivo pelo qual termina sendo mais rápido para somente usar um vetor temporário doque fazendo "atribuição local" ( 5% para dados considerados pequenos)
        ...
        /* Lembre-se que se VOCÊ for implementar seu próprio hashCode framework,
        // tenha certeza de setar corretamente seu "ABCD" inicial de acordo com RFC 1321:
        //    A = 0x67452301;
        //    B = 0xefcdab89;
        //    C = 0x98badcfe;
        //    D = 0x10325476;
        */
        ...
        //Pode parecer CHATO, e é um pouco. MAS desenrolar essas equações manualmente essas equações nos dá 20% de melhora na performace.
        ...
        // implementação da rotação "esquerda" é um "int" ao invés de "uint"
        // porque o CLR requer o argumento passado para  >>/<< do tipo inteiro      
        private static uint LSR(uint i, int s)
        {
            return ((i << s) | (i >> (32 - s)));
        }

        //Converte o vetor de entrada em um vetor de UInts
